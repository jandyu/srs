...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/root/srs/srs/trunk/objs/Platform-Linux-4.4.0-SRS4/ffmpeg-4.2-fit/Platform-Linux-4.4.0-SRS4/_release --pkg-config-flags=--static --extra-libs=-lpthread --extra-libs=-lm --disable-x86asm --disable-programs --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --disable-avformat --disable-swscale --disable-postproc --disable-avfilter --disable-network --disable-dct --disable-dwt --disable-error-resilience --disable-lsp --disable-lzo --disable-faan --disable-pixelutils --disable-hwaccels --disable-devices --disable-audiotoolbox --disable-videotoolbox --disable-cuda-llvm --disable-cuvid --disable-d3d11va --disable-dxva2 --disable-ffnvcodec --disable-nvdec --disable-nvenc --disable-v4l2-m2m --disable-vaapi --disable-vdpau --disable-appkit --disable-coreimage --disable-avfoundation --disable-securetransport --disable-iconv --disable-lzma --disable-sdl2 --disable-everything --enable-decoder=aac --enable-decoder=aac_fixed --enable-decoder=aac_latm --enable-decoder=libopus --enable-encoder=aac --enable-encoder=opus --enable-encoder=libopus --enable-libopus
prefix=/root/srs/srs/trunk/objs/Platform-Linux-4.4.0-SRS4/ffmpeg-4.2-fit/Platform-Linux-4.4.0-SRS4/_release
...
CFLAGS=   -std=c11 -fomit-frame-pointer -pthread -I/root/srs/srs/trunk/objs/Platform-Linux-4.4.0-SRS4/opus-1.3.1/_release/include/opus -I/root/srs/srs/trunk/objs/Platform-Linux-4.4.0-SRS4/opus-1.3.1/_release/include/opus -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
EXTRALIBS-avcodec=-pthread -lm -L/root/srs/srs/trunk/objs/Platform-Linux-4.4.0-SRS4/opus-1.3.1/_release/lib -lopus -lm
